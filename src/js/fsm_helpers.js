define(function (require) {
   ...
   * RESTRICTION : avoid having init and EV_CODE_EFFECT_ERROR as an identifier
  ...
  function create_event_enum(array_identifiers) {
    ...
    // Add reserved event codes ('init', code for effect errors)
    // NOTE : That will overwrite any other event called EV_CODE_INIT...
    event_hash[EV_CODE_INIT] = EV_CODE_INIT;
    event_hash[EV_CODE_EFFECT_ERROR] = EV_CODE_EFFECT_ERROR;
    return event_hash;
  }
