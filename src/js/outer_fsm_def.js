...
function require_outer_fsm_def(Err, utils, constants) {
    ...
    const EXPECTING_ACTION_RESULT = constants.EXPECTING_ACTION_RESULT;
    ...
    function get_internal_sync_fsm() {
        ...
        function update_internals_with_effect_code(fsm_state, internal_event) {
            ...
            return set_internal_state_to_expecting_effect_result(/*OUT*/fsm_state, from, to, effect_code, event_data);
        }
        ...
        function update_model_with_warning(fsm_state, internal_event, error_msg) {
            ...
            return set_internal_state_to_transition_error(/*OUT*/fsm_state, event, event_data, error_msg);
        }
        ...
        function set_internal_state_to_transition_error(fsm_state, event, event_data, error_msg) {
            return {
                internal_state: {
        ...
        function set_internal_state_to_expecting_intent(fsm_state, automatic_event, model_update) {
            return {
        ...
        function transition_to_next_state(fsm_state, internal_event) {
            ...
            var fsm_update = set_internal_state_to_expecting_intent(/*OUT*/fsm_state, automatic_event, model_update);
